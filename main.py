...
class InvidiousAPI:
    def __init__(self):
        self.videos = ast.literal_eval(requests.get('https://raw.githubusercontent.com/yuzu875641/yuki-test1/refs/heads/main/apilist.txt', headers=header, timeout=(1.0, 0.5)).text)
